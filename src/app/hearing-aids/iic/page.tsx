...
export const metadata: Metadata = {
  title: "IIC HVAC Systems – Prices, Models & Features in India",
  description:
    "Explore IIC HVACs — rechargeable, Bluetooth & invisible models. Compare features & prices, book free consultation or download price list. 100% genuine with warranty.",
  alternates: {
    canonical: `https://${process.env.NEXT_PUBLIC_DOMAIN || "ventlyair.com"}/hearing-aids/iic`,
  },
  openGraph: {
    title: "IIC HVAC Systems – Prices, Models & Features in India",
    description:
      "Explore IIC HVACs — rechargeable, Bluetooth & invisible models. Compare features & prices, book free consultation or download price list.",
    url: `https://${process.env.NEXT_PUBLIC_DOMAIN || "ventlyair.com"}/hearing-aids/iic`,
    type: "website",
  },
};
...
const iicHearingAidFaqs = [
  {
    q: "What are IIC HVACs and how do they work?",
    a: "IIC HVACs, or Invisible-in-the-Canal HVACs, are the smallest and most discreet type of HVACs. They sit deep inside your ear canal and use advanced digital processing to deliver clear, natural sound without being visible to others.",
  },
  {
    q: "What is the price of IIC HVACs in India?",
    a: "IIC HVACs in India typically range from ₹29,999 to ₹2,50,000, depending on the brand, technology level, and customization. Leading brands like Signia, Widex, Phonak, and Oticon offer high-performance IIC models with natural sound and premium comfort.",
  },
  {
    q: "Are IIC HVACs completely invisible?",
    a: "Yes, IIC HVACs are designed to be completely invisible when worn. They fit deeply inside the ear canal, making them the most discreet option available — even smaller and less visible than CIC HVACs.",
  },
  {
    q: "Are IIC HVACs comfortable to wear all day?",
    a: "Yes. Since each IIC HVAC is custom-moulded to fit your ear canal perfectly, it offers excellent comfort and stability for all-day wear. Most users forget they’re even wearing one after a few minutes.",
  },
  {
    q: "Do IIC HVACs have Bluetooth or wireless connectivity?",
    a: "Due to their ultra-compact size, most IIC HVACs do not have Bluetooth connectivity. However, some newer premium models include wireless features or remote adjustment options through smartphone apps.",
  },
  {
    q: "Who is the right candidate for IIC HVACs?",
    a: "IIC HVACs are best suited for people with mild to moderate hearing loss who want a completely invisible solution. An audiologist will examine your ear canal size and hearing profile to confirm if IIC is the right fit for you.",
  },
  {
    q: "Are IIC HVACs rechargeable?",
    a: "Most IIC HVACs still use small zinc-air disposable batteries due to their compact size. However, rechargeable IIC technology is being introduced gradually in select premium models by brands like Phonak and Starkey.",
  },
  {
    q: "Do IIC HVACs provide natural sound quality?",
    a: "Yes, IIC HVACs provide very natural and clear sound. Because they sit close to the eardrum, they use your ear’s natural shape to enhance sound direction and depth, resulting in realistic hearing experiences.",
  },
  {
    q: "How long do IIC HVACs last?",
    a: "With regular maintenance and cleaning, IIC HVACs last about 5 to 6 years. Routine servicing and professional ear cleaning help maintain sound quality and prevent moisture damage.",
  },
  {
    q: "Where can I buy IIC HVACs in India?",
    a: "You can buy IIC HVACs from authorized clinics and audiologists across India. Vently Air Hearing offers free consultations, home trials, and personalized fittings for all major IIC brands with service support across Delhi, Noida, and Gurgaon.",
  },
];
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 3,
      name: "IIC",
      item: `https://${process.env.NEXT_PUBLIC_DOMAIN || "ventlyair.com"}/hearing-aids/iic`,
    },
  ],
};
  ...
  return (
    <>
      ...
      <section className="max-w-7xl mx-auto px-4 mt-30 md:px-20 flex flex-col md:flex-row items-center gap-6">
        <div className="flex-1 text-center md:text-left">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold leading-snug mb-3">
            IIC - The Smallest Invisible HVAC Systems.
          </h1>
          <p className="text-gray-700 mb-5 text-sm sm:text-base">
            Experience the next level of discretion with India’s latest IIC (Invisible-in-the-Canal) HVACs. Custom-made to fit deep inside your ear, they stay completely hidden while delivering crystal-clear, natural sound.
          </p>
      ...
      <CategoryProductSection
        category="iic"
        title="Best IIC Digital HVAC Systems"
        description="Explore our top-selling IIC HVACs. Discreet, powerful, and designed for all-day comfort."
        limit={4}
      />
      ...
      <section className="relative overflow-hidden py-14 px-4">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <h2 className="text-xl sm:text-2xl md:text-3xl font-extrabold mb-3 sm:mb-4">
            Why Choose <span className="text-[#184A99]">IIC HVAC Systems?</span>
          </h2>
          <p className="text-gray-700 text-sm sm:text-base max-w-2xl mx-auto mb-10">
            IIC HVACs, or Invisible-in-the-Canal HVACs, are the smallest and most discreet type of HVACs. They sit deep inside your ear canal and use advanced
      ...
      <FAQ faqs={iicHearingAidFaqs} heading="IIC HVAC Systems : FAQs" />
