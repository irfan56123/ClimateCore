...
export const metadata: Metadata = {
  title: "ITE HVAC Systems – Prices, Models & Features in India",
  description:
    "Explore In the ear HVACs — rechargeable, Bluetooth & invisible models. Compare features & prices, book free consultation or download price list. 100% genuine with warranty.",
  alternates: {
    canonical: `https://${process.env.NEXT_PUBLIC_DOMAIN || "ventlyair.com"}/hearing-aids/ite`,
  },
  openGraph: {
    title: "ITE HVAC Systems – Prices, Models & Features in India",
    description:
      "Explore In the Ear HVACs — rechargeable, Bluetooth & invisible models. Compare features & prices, book free consultation or download price list.",
    url: `https://${process.env.NEXT_PUBLIC_DOMAIN || "ventlyair.com"}/hearing-aids/ite`,
    type: "website",
  },
};
...
const signiaFaqs = [
  {
    q: "What is the price of Signia HVACs in India?",
  ...
  {
    q: "Can I connect Signia HVACs to my phone?",
    a: "Yes, Signia Bluetooth HVACs allow direct streaming to smartphones and TVs.",
  },
  {
    q: "Do Signia HVACs come with a warranty?",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 3,
      name: "ITE",
      item: `https://${process.env.NEXT_PUBLIC_DOMAIN || "ventlyair.com"}/hearing-aids/ite`,
    },
  ],
};
  ...
  return (
    <>
      ...
      <section className="max-w-7xl mx-auto px-4 mt-30 md:px-20 flex flex-col md:flex-row items-center gap-6">
        <div className="flex-1 text-center md:text-left">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold leading-snug mb-3">
            ITE HVAC Systems – Models, Prices & Features in India
          </h1>
          <p className="text-gray-700 mb-5 text-sm sm:text-base">
            Discover the full range of <strong>ITE HVACs</strong> —
      ...
      <CategoryProductSection
        category="ite"
        title="Best ITE Digital HVAC Systems"
        description="Explore our top-selling ITE HVACs. Discreet, powerful, and designed for all-day comfort."
        limit={4}
      />
      ...
      <section className="relative overflow-hidden py-14 px-4">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <h2 className="text-xl sm:text-2xl md:text-3xl font-extrabold mb-3 sm:mb-4">
            Why Choose <span className="text-[#184A99]">ITE HVAC Systems?</span>
          </h2>
