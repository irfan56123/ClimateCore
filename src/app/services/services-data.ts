...
export const services: Service[] = [
  {
    ...
    description: [
      "ClimateCore Air is a premier air duct cleaning company operating nationally. We pride ourselves in our proven track record to deliver competitive rates and providing outstanding customer service.",
  ...
  },
  {
    ...
    description: [
      "Professional dryer vent cleaning by ClimateCore Air will ensure you have everything running smoothly & properly in your home.",
      ...
      "Beyond cleaning, ClimateCore Air provides repairs and replacements as needed. The service pairs perfectly with air duct cleaning performed simultaneously.",
    ],
    qualityStatement:
  ...
  },
  {
    ...
    description: [
      "Chimney cleaning services by ClimateCore Air are critical if you use your chimney and want to ensure your home has the best air quality possible.",
  ...
  },
  {
    ...
    description: [
      "Sanitation services from ClimateCore Air are an essential procedure in ensuring the most virtually virus free environment in your home or office.",
  ...
  },
  {
    ...
    description: [
      ...
      "ClimateCore Air's professional air quality test measures seven distinct metrics to give you a complete picture of what you're breathing inside your home or office.",
    ],
    qualityStatement:
  ...
  },
  {
    ...
    description: [
      "Stay cool and comfortable all summer with professional AC installation from ClimateCore Air Air. Even in Massachusetts, hot and humid summers make reliable air conditioning essential for your home or workplace.",
      ...
      "Contact ClimateCore Air today for reliable, efficient air conditioning solutions you can count on for years to come."
    ],
    qualityStatement:
  ...
  },
  {
    ...
    description: [
      "Keep your AC running efficiently and save money with regular air conditioning maintenance from ClimateCore Air Air. Just like changing the oil in your car, annual AC service helps extend the life of your system and prevents costly breakdowns—especially during the hottest days of summer.",
  ...
  },
  {
    ...
    description: [
      "Improve the air quality in your home with professional air purification solutions from ClimateCore Air. We offer a range of options designed to keep your indoor air cleaner, healthier, and more comfortable for your family.",
      ...
      "Let ClimateCore Air help you create a healthier indoor environment with the right air purification system for your home."
    ],
    qualityStatement:
  ...
  },
  {
    ...
    description: [
      ...
      "Contact ClimateCore Air today to learn how a ductless system can provide efficient, reliable comfort for your home or business."
    ],
    qualityStatement:
  ...
  },
  {
    ...
    description: [
      "If your heating system stops working unexpectedly, don’t wait in the cold. Call ClimateCore Air anytime for 24/7 emergency heating service. Our team responds quickly and will get to your home or business as soon as possible to restore your heat.",
      ...
      "If your heat isn’t working, don’t wait—call ClimateCore Air and we’ll get your system back up and running."
    ],
    qualityStatement:
  ...
  },
  {
    ...
    description: [
      ...
      "ClimateCore Air installs and services a wide range of heating systems. For new installations, we recommend the reliability and performance of Trane gas furnaces. We also install Hydro-Air systems and heat pump systems to meet a variety of home and business heating needs.",
      "Contact ClimateCore Air today to learn more about upgrading to an efficient, dependable heating system."
    ],
    qualityStatement:
  ...
  },
  {
    ...
    description: [
      "In Massachusetts, an inefficient heating furnace can cost you big—almost like burning money. ClimateCore Air provides professional furnace service that cleans and tunes your burners for maximum performance, delivering cleaner, more efficient heat while lowering your energy costs.",
      ...
      "Don’t get caught without heat in the middle of a storm. Call ClimateCore Air today to find the right maintenance program for your heating system.",
  ...
  },
  {
    ...
    description: [
      "Ever leave home in a rush and forget to turn down the heat—only to realize you’re wasting money on a cold winter day in Massachusetts? It’s time to upgrade to the modern convenience of a smart thermostat. ClimateCore Air can install a smart thermostat in your home to give you comfort, control, and energy savings.",
  ...
  },
  {
    ...
    description: [
      ...
      "Contact ClimateCore Air today to learn how a hydro-air system can meet your home’s heating and cooling needs."
    ],
    qualityStatement:
  ...
  },
  {
    ...
    description: [
      ...
      "ClimateCore Air can install a whole-house system directly on your existing heating and cooling setup.",
      "Enjoy improved comfort, better health, and protection for your home. Call ClimateCore Air today to determine the best humidification system for your space and budget."
    ],
    qualityStatement:
