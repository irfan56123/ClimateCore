  ...
  return (
    <main className="max-w-4xl mx-auto px-6 py-16 text-gray-800 mt-4">
      ...
      <section className="space-y-6">
        <p>
          At <span className="font-semibold">ClimateCore Air</span>, we value
        ...
        <div>
          ...
          <p>
            ...
            <a
              href={`mailto:support@${process.env.NEXT_PUBLIC_DOMAIN || "ClimateCoreair.com"}`}
              className="text-[#023784] font-medium hover:underline"
            >
              support@{process.env.NEXT_PUBLIC_DOMAIN || "ClimateCoreair.com"}
            </a>
            .
          </p>
        </div>
